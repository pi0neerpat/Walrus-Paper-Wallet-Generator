# Batch ETH Paper Wallet <img alt="wallet" src="readme-resources/wallet.png" align="middle" width="60"> Generator

<p align="center"><img style="border:10px solid black;" alt="single-card" src="readme-resources/single-card.png" align="middle" width='400' >
</p>

Generate and fund :moneybag: hundreds of paper wallets, for a workshop or in-person giveaway :globe_with_meridians: :loudspeaker: :moneybag: :gift:  :chart_with_upwards_trend:
...
## Features
:white_check_mark: Quickly :zap: generate a **.csv**  file with the mnemonic seed, public and private keys for many wallets.
...
:white_check_mark: QR  :camera: addresses  
...
```
#### Here's whats in wallets.csv

| index | mnemonic | privateKey | publicAddress | publicAddressFormatted |  publicAddressQRString |
| ----- | --------------------------- | -------------- | ----------- | ------| ------|
| 1     | push loan... | a6de7...    | 0x952d81a4  | "0xa88...32c7c8", | ethereum:0xa88ed... |

- **publicAddressFormatted** takes care of input syntax when using batch.sol in Remix.
- **publicAddressQRString** is the seed text to generate a QR code in mail-merge.

This is a good point to mention that many new cryptography users and developers struggle with the concept that a blockchain wallet does not "contain" any tokens or funds. Its merely a text file that is used to sign messages. Consider using an icon like this <img alt="wallet" src="readme-resources/wallet.png" align="middle" width="35"> to describe the concept visually.
...
#### Directions  :clipboard: for Users  
...
- Your **neighborhood printers are too lazy** to do anything besides cookie-cutter job. They are **highly unlikely to accept** your business card prints, even if you do a good job explaining the details.
- Online business-card services **don't allow you to configure unique cards**. If you find one, let me know!
- **The only option is to print it yourself**. Buy some plain cardstock and print at home or local mail-service center.
...
Deploy `batch.sol` contract on the appropriate network using [Remix IDE](http://remix.ethereum.org). Then call the `distributeFunds` function using the arguments you just created.


#### Here's a snippet of what you'll run in `batch.sol`
...
Navigate to the Remix IDE to deploy and call this function.

(batch.sol is adapted from my [Eth-Splitter tool](https://github.com/blockchainbuddha/Eth-Splitter-Tool))

## Did you find this useful? *Star this repo* so others can find it!
